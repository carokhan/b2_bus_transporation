  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          //Columns make vertical arrays of children and rows make horizontal arrays of children
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            TextButton(
              //Run this method on press
              onPressed: readNfc,
              //Have the varaiable data represent the text of this button
              child: Text(data),
            ),
            //Filler text, can be deleted
            Text("Hi")
          ],
        ),
      ),
